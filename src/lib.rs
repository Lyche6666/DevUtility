...
#[derive(Debug)]
pub struct DevUtilityProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DevUtilityProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DevUtility processing");
    
    let mut processor = DevUtilityProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DevUtilityProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DevUtilityProcessor::new(false);
